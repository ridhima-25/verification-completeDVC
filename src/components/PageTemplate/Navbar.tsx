  ...
  return (
    ...
    >
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="inline-flex items-center w-full px-[26px] py-2 text-sm text-gray-700 hover:bg-gray-100 lg:px-4"
      >
        Contact us <NewTabIcon className="mx-1.5" />
      </a>
      <a
        id="documentation"
        ...
        className="inline-flex items-center w-full px-[26px] py-2 text-sm text-gray-700 hover:bg-gray-100 lg:px-4"
      >
        Documentation <NewTabIcon className="mx-1.5" />
      </a>
      <button
        id="faq"
        disabled
        className="block text-left w-full px-[26px] py-2 text-sm text-gray-400 hover:bg-gray-100 lg:px-4"
      >
        FAQs
      </button>
    </div>
      ...
      {showMenu && (
        ...
        >
          <a
            id="home-button"
            href={Pages.Home}
            className="block px-1 py-2 text-sm text-gray-700 hover:bg-gray-100"
          >
            Home
          </a>
          <a
            id="verify-credentials-button"
            href={Pages.Home}
            className="block px-1 py-2 text-sm text-primary hover:bg-gray-100"
          >
            Verify Credentials
          </a>
          <div className="relative">
            ...
            >
              Help{" "}
              <MdArrowForwardIos
                className={`mx-1.5 ${showSubMenu ? "rotate-90" : ""}`}
              />
            </button>
            {showSubMenu && <SubMenu />}
          </div>
      ...
      <ul className="hidden lg:flex mt-4 lg:flex-row lg:space-x-10 lg:mt-0 lg:text-sm lg:font-medium">
        ...
        <li className="relative">
          ...
          >
            Help{" "}
            <MdExpandLess
              className={`mx-1.5 ${showHelp ? "" : "rotate-180"}`}
            />
          </button>
          {showHelp && <SubMenu />}
        </li>
        ...
        <div>
          <a href={Pages.Home} className="flex items-center">
            <img
              ...
              src="/assets/images/emblem-dark.png"
              alt="emblem"
            />
            <img
              id="agri-stack-logo"
              className="h-[100%]"
              src="/assets/images/agri_stack_logo.svg"
              alt="agri-stack-logo"
            />
          </a>
        </div>
